...
namespace SetupExportParser.Logic
{
    public class Corner
    {
        ...
        public Corner(string data)
        {
            ...
            SpringRate = Convert.ToInt32(cornerData(3).Split(":")(1).Trim());
            BumpStiffness = cornerData(4).Trim();
            ReboundStiffness = cornerData(5).Trim();
        }
